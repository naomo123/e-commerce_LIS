    				...
    				<div class="container-fluid">
    					<form method="POST" action="logic/edit.php">
    						...
    						<div class="row form-group">
    							...
    							<div class="col-sm-10">
    								<textarea col="12" class="form-control" style="resize: vertical;" id="descripcion" name="descripcion" rows="6" ><?php echo $producto->descripcion; ?></textarea>
    							</div>
    						</div>
    						<div class="row form-group">
    							<div class="col-sm-2">
    						...
    						<div class="row form-group">
    							...
    							<div class="col-sm-10">
    								<select class="form-control form-select-sm" name="categoria" aria-label=".form-select-sm example">
    	...
    	<div class="modal-dialog">
    		<div class="modal-content">
    			...
    			<div class="modal-footer">
    				...
    				<a href="logic/delete.php?codigo=<?php echo $producto->codigo; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
    			</div>
